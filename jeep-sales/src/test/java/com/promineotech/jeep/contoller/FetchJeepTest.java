...
import com.promineotech.jeep.contoller.support.FetchJeepTestSupport;
...
class FetchJeepTest extends FetchJeepTestSupport {
  ...
  class TestsThatDoNotPolluteTheAppliationContext extends FetchJeepTestSupport{
    @Test
    ...
    @ParameterizedTest
    @MethodSource("com.promineotech.jeep.contoller.FetchJeepTest#parametersForInvalidInput")
  ...
  static Stream<Arguments> parametersForInvalidInput(){
    return Stream.of(
        arguments("WRANGLER", "!@#$%%!", "Trim contains non-alpha-numeric values"),
  ...
  class TestsThatPolluteTheApplicationContext extends FetchJeepTestSupport{
    ...
    void testThatAnUnplannedErrorResultsInA500Status() {
      ...
      doThrow(new RuntimeException("Oh no!")).when(jeepSalesService).fetchJeeps(model, trim);
